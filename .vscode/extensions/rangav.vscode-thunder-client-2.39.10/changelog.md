...
# [v2.39.10](https://github.com/rangav/thunder-client-support/releases/tag/v2.39.10) - (2026-03-02)

## Bug Fixes

- Do not save default envrionment selection into project files [#766](https://github.com/thunderclient/thunder-client-support/issues/766), [#1727](https://github.com/thunderclient/thunder-client-support/issues/1727)
- All Environments Deselected [#1667](https://github.com/thunderclient/thunder-client-support/issues/1667)

# [v2.39.9](https://github.com/rangav/thunder-client-support/releases/tag/v2.39.9) - (2026-02-23)

## New Features

- Custom query param in the OAuth request [#1731](https://github.com/thunderclient/thunder-client-support/issues/1731)

# [v2.39.5](https://github.com/rangav/thunder-client-support/releases/tag/v2.39.5) - (2026-02-16)

We’re excited to announce that `Thunder Client `is coming soon to `JetBrains IDEs`.

## Coming Soon: Thunder Client for JetBrains IDEs

<img width="800" alt="thunder-client-intellij" src="https://github.com/user-attachments/assets/52c62617-f06f-4b9e-820d-336c031d9294" />
...
- Early access available: companies interested in trying the beta version can [contact us](https://www.thunderclient.com/contact?utm_source=ext_jetbrains)

# [v2.39.0](https://github.com/rangav/thunder-client-support/releases/tag/v2.39.0) - (2026-02-08)
...
- Freeze the field "modified" in the database JSON files [#1728](https://github.com/thunderclient/thunder-client-support/issues/1728)
...
- Fix: TC CLI ignored the `--iterations` option when running a folder [#1734](https://github.com/thunderclient/thunder-client-support/issues/1734).
